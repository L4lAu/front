    ...
    <>
      ...
      <aside className={`${styles.sidebar} ${aberta ? styles.aberta : ''} ${mini && !isMobile ? styles.mini : ''}`}>
        ...
        <nav className={styles.menu}>
          <a href="/Home" className={styles.link}><Home size={20} /> {!(mini && !isMobile) && 'HOME'}</a>
          ...
          {!(mini && !isMobile) && (
            <div className={`${styles.dropdown} ${dropdownTurmasAberto ? styles.dropdownAberto : ''}`}>
              <a href="/Turmas" className={styles.subLink}>Ensino Médio</a>
              <a href="/Turmas" className={styles.subLink}>Ensino Técnico</a>
            </div>
          )}
        ...
        <div className={styles.configuracoesContainer}>
          ...
          {!(mini && !isMobile) && (
            <div className={`${styles.dropup} ${dropupConfigAberto ? styles.dropupAberto : ''}`}>
              <a href="#" className={styles.subLink}>Sair</a>
              <a href="#" className={styles.subLink}>Contato</a>
              <a href="#" className={styles.subLink}>Sobre Nós</a>
            </div>
          )}
        </div>
      </aside>
