...
export default function Portugues() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3000/dados/Materia/Inteligência%20Artificial%20na%20Automação`)
            .then(res => {
    ...
    return (
        <div>
            <div className="mx-5 my-8 p-8 md:p-14 border-4 border-[#556b2f] rounded-lg bg-[url('https://www.opencadd.com.br/hubfs/inteligencia-artificial-automacao-de-industrias.jpg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center min-h-[300px] md:min-h-[400px] relative overflow-hidden">
