...
export default function Portugues() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3000/dados/Materia/Programacao%20Backend`)
            .then(res => {
    ...
    return (
        <div>
            <div className="mx-5 my-8 p-8 md:p-14 border-4 border-[#556b2f] rounded-lg bg-[url('https://images.prismic.io/voitto-blog/17f7d622-3a54-480e-be53-5dd7296bddce_desenvolvedor+backend.jpg?auto=compress,format?w=3840&q=75')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center min-h-[300px] md:min-h-[400px] relative overflow-hidden">
