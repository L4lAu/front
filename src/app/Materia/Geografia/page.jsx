...
export default function Portugues() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:3000/dados/Materia/geografia`)
            .then(res => {
    ...
    return (
        <div>
            <div className="mx-5 my-8 p-8 md:p-14 border-4 border-[#556b2f] rounded-lg bg-[url('https://s2-oglobo.glbimg.com/nGDkEzzieeumTbOI3taCwbWVwrQ=/0x0:1721x1102/924x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_da025474c0c44edd99332dddb09cabe8/internal_photos/bs/2024/K/j/dGcmDrTwKcKQGYfXn4AQ/geografia.jpg')] bg-cover bg-center bg-no-repeat flex flex-col items-center justify-center min-h-[300px] md:min-h-[400px] relative overflow-hidden">
