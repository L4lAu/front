...
export default function SobreContatoPage() {
  ...
  return (
    <main className="min-h-screen font-serif text-[#556b2f]">
        
       <div className="p-4 sm:p-6 lg:p-8 space-y-16 sm:space-y-20">
           
             <header 
                className="relative bg-cover bg-center text-center py-20 rounded-2xl overflow-hidden flex items-center justify-center animate-fade-in-up shadow-[0_7px_0px_1.1px] shadow-[#556b2f]" 
            ...
            >
             ...
             <section id="formulario-contato"  className="text-center">
